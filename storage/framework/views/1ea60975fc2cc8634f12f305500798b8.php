<?php
    ...
    $siteLogo = $globalSettings->get('site_logo') ? \Illuminate\Support\Facades\Storage::disk('public')->url($globalSettings->get('site_logo')) : null;
    $siteFavicon = $globalSettings->get('site_favicon') ? \Illuminate\Support\Facades\Storage::disk('public')->url($globalSettings->get('site_favicon')) : null;
...
<?php /**PATH D:\Laravel Project\beanvista\resources\views/frontend.blade.php ENDPATH**/ ?>