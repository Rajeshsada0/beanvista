...
class CmsController extends Controller
{
    ...
    public function index()
    {
        ...
        $settings = [
            ...
            'site_logo' => $settingsRaw->get('site_logo') ? Storage::disk('public')->url($settingsRaw->get('site_logo')) : null,
            'site_favicon' => $settingsRaw->get('site_favicon') ? Storage::disk('public')->url($settingsRaw->get('site_favicon')) : null,
        ...
        for ($i = 1; $i <= 9; $i++) {
            ...
            $settings["feature_image_$i"] = $dbImg ? Storage::disk('public')->url($dbImg) : $defaultFeatures[$i]['image'];
        }
